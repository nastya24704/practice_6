...
if x2<a1 or y1<b2 or y2>b1 or a2<x1:
    ...
    print('Один прямоугольник лежит внутри другого,  не касаясь.')
# это всегда только касание
elif x2==a1 or y1==b2 or y2==b1 or a2==x1:
    print('Прямоугольники имеют касание')
# может быть с пересечением, но я пока это не учитываю
elif x1==a1 or x2==a2 or y1==b1 or y2 == b2:
    print('Прямоугольники имеют касание')
# рассмотрим ситуацию, когда нижняя грань совпадает
